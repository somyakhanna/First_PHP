...
<header class="header-wrapper">
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="logo">
                <a title="Vehile Theft" href="#">
               <img  src="pics/logo.png" height="40px"  alt="Logo">
                </a>
              </div>
              ...
              <div class="navbar navbar-default mainnav">
                ...
                <div class="collapse navbar-collapse">
                  <ul class="nav navbar-nav navbar-right">
                    <li><a href="policehome.php">Dashboard </a>
                    ...
                    <li ><a href="about.php">About Us</a></li>
                                       <li><a href="feedback.php">Feedback</a></li><!-- /Contact Pages -->
